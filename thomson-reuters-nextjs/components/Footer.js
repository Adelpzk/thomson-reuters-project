              ...
              <div class="tr-SiteFooter-inner">
                ...
                >
                  <div class="tr-SiteFooter-searchInner">
                    <div
                      class="tr-SearchInput tr-SearchInput--dark"
                    ...
                    >
                      <label
                        class="tr-SearchInput-label u-hiddenVisually"
                        for="searchInput-1"
                      >
                        Search
                      </label>
                      <div class="tr-SearchInput-box">
                        ...
                        <div class="tr-SearchInput-buttons">
                          <button
                            ...
                            class="tr-SearchInput-clearButton"
                            type="button"
                          >
                          ...
                          <button
                            ...
                            class="tr-SearchInput-searchButton"
                            type="submit"
                          >
                            <div class="tr-SearchInput-icon">
                              <span class="tr-Svg">
                      ...
                      <div class="tr-SearchInput-typeahead" tabindex="-1">
                        <ul
                          class="tr-SearchInput-typeaheadItems"
                ...
                <nav class="tr-SiteFooter-lists">
                  <ul class="tr-SiteFooter-listsInner">
                    <li
                      class="tr-SiteFooterNavList"
                      data-rehydratable="tr-SiteFooter.NavList"
                      data-title="Resources"
                    >
                      <button
                        class="tr-SiteFooterNavList-title"
                        role="button"
                        aria-label="Thomas Reuters"
                        aria-haspopup="true"
                        aria-expanded="false"
                      >
                        <span class="tr-SiteFooterNavList-text u-typographySmallCaps">
                          Resources
                        </span>
