...
{/* </div> */}
      ...
      <div className = "tr-Grid-items">  
       <div className="tr-Grid-item">
        ...
        <div data-react-from-markup-container="" className="tr-FiltersSection-borders">
          <div className = "tr-FiltersSection"><button className="tr-FiltersSection-heading" aria-expanded="false"><span className="tr-Typography tr-Typography--undefined tr-Typography--left"><strong>Jurisdiction</strong></span><span className="tr-FiltersSection-expandButton tr-Typography tr-Typography--xs tr-Typography--left">+</span></button>
        ...
        <div className = "tr-FiltersSection"><button className="tr-FiltersSection-heading" aria-expanded="false"><span className="tr-Typography tr-Typography--undefined tr-Typography--left"><strong>Practice area</strong></span><span className="tr-FiltersSection-expandButton tr-Typography tr-Typography--xs tr-Typography--left">+</span></button>
        </div>
        </div>
    
        
        <div data-react-from-markup-container="" class="tr-FiltersSection-borders">
        <div className = "tr-FiltersSection"><button className="tr-FiltersSection-heading" aria-expanded="false"><span className="tr-Typography tr-Typography--undefined tr-Typography--left"><strong>Product type</strong></span><span className="tr-FiltersSection-expandButton tr-Typography tr-Typography--xs tr-Typography--left">+</span></button>
        </div>
        </div>
    
        
        <div data-react-from-markup-container="" class="tr-FiltersSection-borders">
        <div className = "tr-FiltersSection"><button className="tr-FiltersSection-heading" aria-expanded="false"><span className="tr-Typography tr-Typography--undefined tr-Typography--left"><strong>Publisher</strong></span><span className="tr-FiltersSection-expandButton tr-Typography tr-Typography--xs tr-Typography--left">+</span></button>
      ...
      <div class="tr-CleanFiltersSection">
        ...
        <div class="tr-PaginationItem">
            <nav class="tr-Pagination" role="navigation" aria-label="Pagination Navigation">
                
                <ul class="tr-Pagination-items">
                    <li class="tr-PaginationNavigation tr-PaginationNavigation--left is-disabled">
                        
                        
                            <span aria-label="Previous" class="tr-PaginationNavigation-slider is-disabled" data-testid="navItemLeft">
                                <div class="tr-PaginationNavigation-iconWrapper tr-PaginationNavigation-iconWrapper--disabled">
                                    <span class="tr-PaginationNavigation-icon tr-PaginationNavigation-iconLeft">
        ...
        <span class="tr-Svg-inner">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true">
                <path d="M10 8l4 4-4 4" fill="none" stroke="currentColor" stroke-linecap="square" stroke-width="2"></path>
                    ...
                    <li class="tr-PaginationPageItem is-active">
                            <span class="tr-PaginationPageItem-innerWrapper" aria-current="true" data-testid="pageItem" aria-label="Current Page, Page 1">
                                <span class="tr-PaginationPageItem-wrapper">1</span>
                            </span>
                    </li>
                    
                        
                            <li class="tr-PaginationPageItem">
                                
                                <a class="tr-PaginationPageItem-innerWrapper is-clickable" href="/en-ca/search?Site=ue_canada&amp;i=1&amp;page=2&amp;sp_c=20" aria-current="false" aria-label="Go to Page 2" data-testid="pageItem">
                                    <span class="tr-PaginationPageItem-wrapper">2</span>
                                </a>
                            </li>
                        
                            <li class="tr-PaginationPageItem">
                                
                                <a class="tr-PaginationPageItem-innerWrapper is-clickable" href="/en-ca/search?Site=ue_canada&amp;i=1&amp;page=3&amp;sp_c=20" aria-current="false" aria-label="Go to Page 3" data-testid="pageItem">
                                    <span class="tr-PaginationPageItem-wrapper">3</span>
                                </a>
                            </li>
                        
                            <li class="tr-PaginationPageItem"> 
                                <a class="tr-PaginationPageItem-innerWrapper is-clickable" href="/en-ca/search?Site=ue_canada&amp;i=1&amp;page=4&amp;sp_c=20" aria-current="false" aria-label="Go to Page 4" data-testid="pageItem">
                                    <span class="tr-PaginationPageItem-wrapper">4</span>
                                </a>
                            </li>
                            <li class="tr-PaginationPageItem">
                                
                                <a class="tr-PaginationPageItem-innerWrapper is-clickable" href="/en-ca/search?Site=ue_canada&amp;i=1&amp;page=5&amp;sp_c=20" aria-current="false" aria-label="Go to Page 5" data-testid="pageItem">
                                    <span class="tr-PaginationPageItem-wrapper">5</span>
                                </a>
                            </li>
                        
                            <li class="tr-PaginationPageItem"> 
                                <a class="tr-PaginationPageItem-innerWrapper is-clickable" href="/en-ca/search?Site=ue_canada&amp;i=1&amp;page=6&amp;sp_c=20" aria-current="false" aria-label="Go to Page 6" data-testid="pageItem">
                                    <span class="tr-PaginationPageItem-wrapper">6</span>
                                </a>
                            </li>
                            <li class="tr-PaginationPageItem">  
                                <a class="tr-PaginationPageItem-innerWrapper is-clickable" href="/en-ca/search?Site=ue_canada&amp;i=1&amp;page=7&amp;sp_c=20" aria-current="false" aria-label="Go to Page 7" data-testid="pageItem">
                                    <span class="tr-PaginationPageItem-wrapper">7</span>
                                </a>
                            </li>
                            <li class="tr-PaginationPageItem">   
                                <a class="tr-PaginationPageItem-innerWrapper is-clickable" href="/en-ca/search?Site=ue_canada&amp;i=1&amp;page=8&amp;sp_c=20" aria-current="false" aria-label="Go to Page 8" data-testid="pageItem">
                                    <span class="tr-PaginationPageItem-wrapper">8</span>
                                </a>
                            </li>
                        
                            <li class="tr-PaginationPageItem">
                                
                                <a class="tr-PaginationPageItem-innerWrapper is-clickable" href="/en-ca/search?Site=ue_canada&amp;i=1&amp;page=9&amp;sp_c=20" aria-current="false" aria-label="Go to Page 9" data-testid="pageItem">
                                    <span class="tr-PaginationPageItem-wrapper">9</span>
                                </a>
                            </li>
                            <li class="tr-PaginationPageItem">
                                <a class="tr-PaginationPageItem-innerWrapper is-clickable" href="/en-ca/search?Site=ue_canada&amp;i=1&amp;page=10&amp;sp_c=20" aria-current="false" aria-label="Go to Page 10" data-testid="pageItem">
                                    <span class="tr-PaginationPageItem-wrapper">10</span>
                                </a>
                            </li>
                    <li class="tr-PaginationNavigation tr-PaginationNavigation--right ">
                        
                        <a class="tr-PaginationNavigation-slider" href="/en-ca/search?Site=ue_canada&amp;i=1&amp;page=2&amp;sp_c=20" aria-label="Next" data-testid="navItemRight">
                            <div>Next</div>
                            <div class="tr-PaginationNavigation-iconWrapper tr-PaginationNavigation-iconWrapper">
                                
                                    <span class="tr-PaginationNavItem-icon tr-PaginationNavigation-iconRight">
    ...
    <span class="tr-Svg">
        ...
        <div data-react-from-markup-container="">
            <div class="tr-PaginationFilter" data-rehydratable="tr-PaginationFilter" data-prop-translations="{&quot;PaginationFilter.PerPageLabel&quot;:&quot;Results per page:&quot;}" data-prop-options="[&quot;20&quot;,&quot;30&quot;,&quot;50&quot;]" data-prop-defaultsearchamount="20"><div class="tr-Typography tr-Typography--xs tr-Typography--left"><span id="paginationFilterTitle">Results per page:</span></div><div class="tr-Popover" data-rehydratable="tr-Popover"><div class="tr-Popover-trigger" data-rehydratable-trigger="true"><div class="tr-PopoverTrigger"><div id="popoverContent-3" aria-controls="popoverContent-3" aria-haspopup="true" aria-labelledby="paginationFilterTitle" aria-expanded="false" class="tr-PopoverTrigger-container" role="button" tabindex="0"><div class="tr-PaginationFilter-dropdownOpenButton tr-PaginationFilter-dropdownOpenButton--closed">20<div class="tr-PaginationFilter-chevronIconWrapper tr-PaginationFilter-chevronIconWrapper--closed"><span class="tr-Svg"><span class="tr-Svg-inner"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true"><path d="M16 10l-4 4-4-4" fill="none" stroke="currentColor" stroke-linecap="square" stroke-width="2"></path></svg></span></span></div></div></div></div></div><div id="popoverContent-3" class="tr-PopoverContent" role="tooltip" data-placement="bottom" style={{"position": "absolute", "will-change": "transform", "top": "0px", "left": "0px", "transform": "translate3d(832px, 7200px, 0px)"}}><div class="tr-PopoverBox tr-PopoverBox--trPaginationFilterPopoverWrapper"><span class="tr-Popover-children" data-rehydratable-children="true"><button id="menuItem20" class="tr-PaginationFilter-menuItem tr-PaginationFilter-menuItem--selected">20</button><button id="menuItem30" class="tr-PaginationFilter-menuItem">30</button><button id="menuItem50" class="tr-PaginationFilter-menuItem">50</button></span></div></div></div></div>
        </div>   
        </div>
    </div>
        </div>  
